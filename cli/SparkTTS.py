    ...
    def process_prompt(
        ...
        if use_multilingual:
            ...
            if language == "nl":
                ...
                language_token = "<|language_fr|>"
            elif language == "de":
                language_token = "<|language_de|>"
            elif language == "it":
                language_token = "<|language_it|>"
            elif language == "pl":
                language_token = "<|language_pl|>"
            elif language == "pt":
                language_token = "<|language_pt|>"
            elif language == "es":
                language_token = "<|language_es|>"
            elif language == "en":
                language_token = "<|language_en|>"
            else:
